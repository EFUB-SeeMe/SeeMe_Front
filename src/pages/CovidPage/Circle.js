...
function Circle({text,num}) {
    ...
    return (
        ...
        return(
        <Wrapper >
           <ColorCircle2 > <p style={{fontSize:"15px",fontFamily:"NotoSans",margin:"0px"}}>안전지수</p> {97} </ColorCircle2>
        ...
        return(
        <Wrapper >
           <ColorCircle3 > <p style={{fontSize:"15px",fontFamily:"NotoSans",margin:"0px"}}>안전지수</p> {97} </ColorCircle3>
           <FontWrapper3>{"보통"}</FontWrapper3>
        </Wrapper>);
    }else{
        return(
        <Wrapper >
           <ColorCircle4 > <p style={{fontSize:"15px",fontFamily:"NotoSans",margin:"0px"}}>안전지수</p> {97} </ColorCircle4>
